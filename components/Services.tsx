  ...
  return (
    <section>
        <div className="px-4 sm:px-8 md:px-12">
            ...
            <span className="flex w-fit text-secundaria font-medium text-base ">Nossos serviços  </span>
            <h1 className="text-3xl text-secundaria font-bold uppercase"> Suporte integrado com um parceiro confiável</h1>
